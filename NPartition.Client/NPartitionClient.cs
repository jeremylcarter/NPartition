...
using NPartition.Client.Cache;

namespace NPartition.Client
{
    public class NPartitionClient
    {
        public PartitionCache Cache { get; set; }
        public bool EnableCache { get; set; }
        public Uri BaseAddress { get; set; }

        private HttpClient _client;
        public NPartitionClient(string address, int port, bool cache = true)
        {
            EnableCache = cache;
        ...
        public NPartitionClient(int port = 7070, bool cache = true)
        {
            EnableCache = cache;
